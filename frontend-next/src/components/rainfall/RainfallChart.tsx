...
export default function RainfallChart({
  ...
  return (
    <div className="w-full h-80 bg-slate-900/60 border border-slate-800 rounded-lg p-3 flex flex-col">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-slate-500 font-mono">
            (Hourly Rate vs Empirical Threshold)
          </span>
        </div>
        <div className="flex items-center gap-3 text-[11px]">
          <span className="flex items-center gap-1 text-slate-400">
            <span className="w-2.5 h-2.5 bg-sky-500/80 rounded-sm" /> Hourly (mm)
          </span>
          <span className="flex items-center gap-1 text-slate-400">
            <span className="w-2.5 h-2.5 bg-amber-500/40 border border-amber-500 rounded-sm" /> 24h Cumulative (mm)
          </span>
          <span className="flex items-center gap-1 text-red-400 font-mono">
            <span className="w-3 h-0.5 bg-red-500" /> Threshold ({threshold24h}mm)
          </span>
        </div>
      </div>

          ...
          return (
            ...
            >
              <div
                ...
                className="p-4 cursor-pointer hover:bg-slate-800/40 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4"
              >
                {/* Rank & Zone Info */}
                <div className="flex items-center gap-3.5">
                  <div
                    className={`
                      w-9 h-9 rounded-lg flex items-center justify-center font-mono font-black text-sm shrink-0 border
                      ${
                        item.rank === 1
                ...
                <div className="flex items-center gap-4 shrink-0">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] text-slate-500 font-mono uppercase block">Priority Score</span>
                    <span
              ...
              {isExpanded && (
                <div className="p-4 bg-slate-950/90 border-t border-slate-800 space-y-3.5">
                  ...
                  <div className="flex justify-end gap-2 pt-1">
                    <Link
                      href="/risk-map"
                      className="px-3 py-1.5 rounded text-xs font-bold bg-slate-800 text-slate-200 border border-slate-700 hover:bg-slate-700 transition-colors"
                    >
                      Locate on GIS Map
                    </Link>
                    <Link
                      href="/alerts"
                      className="px-3 py-1.5 rounded text-xs font-bold bg-amber-600 text-slate-950 hover:bg-amber-500 transition-colors"
                    >
